...
LRESULT CALLBACK WndProc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam) {
	switch(Message) {
		case WM_CREATE:
			{MessageBox(hwnd,"This Is Windows Application Is Developed To Calculate Resistance Of Resistor By Color Code.\nINSTRUCTION:\n ->.Click On The Displayed Buttons On The Next Screen For Each Band \n \n  Developed By Rahul Ka Patel\n Tirthraj Rana\nChirag Padaliya\n Shaktisinh Jhala","MESAGE", MB_OK);
			loadimages();
				//CHARUSAT LOGO
	...
	class resistance
{
    ...
    void input(int c[0],int [1],int c[2],int c[3])
    {
        calc();
        putdata();
    }
